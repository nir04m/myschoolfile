...
def Rocks_cb():
	...
	engine.add_obj(obj)
# missile function for the game to fire
...
def input_cb(key):
	...
	if key == 'space' and injump == False:
		s.me.flap()
	if key == 'Return' and gameover == False and countofmissilex < 2 and countofmissiley < 2 and injump == False:
		countofmissilex = countofmissilex + 1
		countofmissiley = countofmissiley + 1
		upmissile_cb()
		sidemissile_cb()
...
def play(postfn=None):
	...
	engine.add_random_event(0.002, Rocks_cb)
